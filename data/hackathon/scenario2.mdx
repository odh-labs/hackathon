...
You've agreed to show them how it's done and are joining the MicroSoft Skype for Business™ call in 5 minutes. Can you win back the support of Peter and keep the deal on track? Time to shine 😅
...
That's it, you nailed it! Peter is impressed with how quickly and clearly you stepped him through the process at short notice and is back on side 🎉
...
If you have won Peter back on side take a screenshot of the output from `nvidia-smi` and post a message in `#event-anz-ocp-ai-hackathon` with the screenshot and message:
