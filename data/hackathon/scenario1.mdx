...
Todays' moderators will assign your team both of the following 
1. Cloud Cluster (represented by ROSA)
2. On-premises Cluster (represented by Single Node OpenShift)
