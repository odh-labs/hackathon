...
## 3.1 - Install  operators related to Openshift AI 
...
## 3.3 - Replicate Model to Cloud Storage
...
TODO: @James - I've reversed 3.1 and 3.3 as they may need my Jupyter Notebook 



## 3.4.1 - Use OpenShift AI to push Granite model from On Prem object storage to cloud
...
### 3.4.2 - Create a Single Model Server on your cloud based OpenShift
...
[3.4.1] You can import this yaml to set up your vLLM server
...
[3.4.3] You can use this JSON as the API body to make an inference call
